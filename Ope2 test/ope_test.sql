...
create procedure eksam_view_kiirviik()
	begin
		...
		begin try
			...
			else	insert Staatus values ('Eksam', 'Vaade "v_kiirviik" kirjete arv', 'on vale, peab olema 26', 'VIGA', eksam_v_kiirviik_kirjete_arv*0, eksam_v_kiirviik_kirjete_arv, eksam_jr);
			endif;
		end try
		begin catch
