...
/* Muutuja, mis määrab, millist õppeainet kontrollitakse. "A" = Andmebaasid, "AA" = Andmebaaside alused, "AAA" = 2022 kevad andmebaasid */
create or replace variable aine varchar(5) = 'AAA';
...
if 	versioon > 3 and aine != 'AAA' then
	begin try
		delete 	partiid;
	end try
	begin catch
